...
//         </ul>
//       </section>
//       <footer className="absolute inset-x-0 bottom-0 flex w-full items-center justify-between border-t border-t-gray-6 bg-gray-2 px-8 py-2 text-xs text-primary">
